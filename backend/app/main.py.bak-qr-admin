...
from .models import CashRegisterSession, Expense, InventoryMovement, Product, Sale, SaleItem
from .schemas import CashRegisterCloseCreate, CashRegisterOpenCreate, ExpenseCreate, InventoryAdjustmentCreate, ProductCreate, ProductRead, SaleCreate
...
@app.post("/api/cash-register/open", status_code=status.HTTP_201_CREATED)
